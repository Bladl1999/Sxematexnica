    ...
    public void paint(Graphics g)
 	{
            ...
            g.drawLine(x - 70, y + h + 10, x - 70, y + h + 50);
            g.drawLine(x - 70, y + h + 50, x + w + 10, y + h + 50);
            
            g.drawString("K", 0, y + h + 90);
            g.drawLine(x - 70, y + h + 60, x - 70, y + h + 100);
            g.drawLine(x - 70, y + h + 100, x + w + 10, y + h + 100);
            
            g.drawString("C", 0, y + h + 140);
            g.drawLine(x - 70, y + h + 110, x - 70, y + h + 150);
            g.drawLine(x - 70, y + h + 150, x + w + 10, y + h + 150);
            
            g.drawString("Q", 0, y + h + 190);
            g.drawLine(x - 70, y + h + 160, x - 70, y + h + 200);
            g.drawLine(x - 70, y + h + 200, x + w + 10, y + h + 200);
            
            g.drawString("Q'", 0, y + h + 240);
            g.drawLine(x - 70, y + h + 210, x - 70, y + h + 250);
            g.drawLine(x - 70, y + h + 250, x + w + 10, y + h + 250);
